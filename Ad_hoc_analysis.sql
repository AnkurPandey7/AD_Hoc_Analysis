...
/*2. What is the percentage of unique product increase in 2021 vs. 2020?
 ...
 SELECT X.A AS unique_product_2020 , Y.B AS unique_product_2021 , ROUND((B-A)*100/A,2) AS percentage_chg 
 FROM 
     (
...
SELECT 
cte1.A AS segment , cte1.B AS product_count_2020 , cte2.D AS product_count_2021 , (cte2.D - cte1.B) AS difference
FROM cte1 
join cte2 
ON cte1.A = cte2.C ;
...
SELECT cte1.division, cte1.product_code, cte1.product, cte2.total_sold_qty, cte2.Rank_order
FROM cte1
